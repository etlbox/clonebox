...
namespace CloneBox.Tests {
    public class NeedTriageTests {
        ...
        [Fact]
        public void EnumeratorCloneKeepsCurrentPosition() {
            var arr = new[] { 1, 2, 3 };
        ...
        [Fact(Skip = "CloneX on X509Certificate2 corrupts native key handles and crashes the test host")]
        public void X509Certificate2CloneDoesNotCorruptNativeHandles() {
        ...
        [Fact]
        public void PointerFieldsKeepOriginalAddresses() {
        ...
        [Fact]
        public void RuntimeTypeStaysSameInstance() {
        ...
        [Fact]
        public void ReadOnlyCollectionIsClonedIndependently() {
